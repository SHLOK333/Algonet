...
function AddRuleModal({ isOpen, onClose, onAdd }) {
  const [tokenType, setTokenType] = useState("pay_per_use");
      ...
      <ModalContent>
        ...
        <ModalBody>
          <FormControl mb={4}>
            ...
            <Select title="Token type" aria-label="Token type" value={tokenType} onChange={(e) => setTokenType(e.target.value)}>
              <option value="pay_per_use">Pay-per-use (x402)</option>
              <option value="asa_nft_optional">Optional ASA/NFT Verification</option>
            </Select>
          </FormControl>
          <FormControl mb={4}>
            <FormLabel>Payee Address / Wallet</FormLabel>
            <Input
              value={address}
          ...
          <FormControl mb={4}>
            <FormLabel>Minimum ASA Amount</FormLabel>
            <Input
              value={tokenAmount}
